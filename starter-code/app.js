...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Did it with one line! -->', sum(1, 2, 3, 4));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Feels right', objectLit());
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Also seems right', sumAndProduct(3, 9));


let message = name => `Hello, ${name}!`

// TODO: Uncomment the following line of code to see the output in the browser console
console.log('WOW!:', message('Allie'));
...
//Answer: Arrow functions do not have their own `this`. The scope is the whole window.Arrow functions are best suited for non-method functions.
